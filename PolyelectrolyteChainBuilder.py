#!/usr/bin/python
# PolyelectrolyteChainBuilder.py
# Date: 07/19/2016
# Author: Yanfei Tang & Dr. Shengfeng Cheng

oneline = "This is a script that generates polyelectrolyte solution configuration without counterions and salt for molecular dynamics simulation. Counterions and salt's electro effect is treated as Yukawa potential."
...
Usage:
./PolyelectrolyteChainBuilder.py len_pan num_pan len_pcat num_pcat vol_ratio charge_fraction
"""
...
class PEChainBuilder:
    """
    The Attribute is explained in every function when it firstly apperears.
    """

    def __init__(self, len_pan, num_pan, len_pcat, num_pcat, vol_ratio, charge_fraction):
        """
        Constructor.
        Attributes:
        -----------
...
if __name__ == "__main__":
    ...
    model = PEChainBuilder(len_pan, num_pan, len_pcat, num_pcat, vol_ratio, charge_fraction)
    model.genChains()
